...
class W2VAASIST(nn.Module):
    def __init__(self):
        ...
        self.encoder = ResNet(2,256,resnet_type='50')
        # https://blog.51cto.com/u_16106623/6261705
        #from resnet50_selfattention import ResNet50
        #self.encoder = ResNet50(resolution=tuple((42,67)), heads=8)
        self.LL = nn.Linear(1024, 128)
        # self.LL = nn.Sequential(nn.Linear(3328, 1024),
...
class LCNN(nn.Module):
    def __init__(self, num_nodes, enc_dim=80, nclasses=2):
